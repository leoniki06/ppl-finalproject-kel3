...
<body>
    ...
    <div class="navbar">
        ...
        <div class="group-2">
            ...
            {{-- FORM LOGIN PENJUAL --}}
            <form class="js-form" data-form-type="login-seller" method="POST" action="#">
                @csrf
    ...
    {{-- JS opsional (toggle password, validasi, dll) --}}
    {{-- Kalau nanti kamu pakai file JS khusus auth, tinggal ganti nama filenya --}}
