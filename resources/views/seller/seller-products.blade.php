        ...
        <div class="page">
            ...
            <div class="card hero">
                <div style="min-width:0">
                    ...
                    <p class="hSub">
                        {{ $today }} • Kelola katalog dengan cepat: update harga, stok, dan pastikan item
                        <b>FLASH</b> tampil optimal.
                    </p>

                    <div class="metaRow">
                        <div class="pillMini"><i class="fa-solid fa-box"></i> Total <b>{{ $totalProducts }}</b></div>
                        <div class="pillMini"><i class="fa-solid fa-circle-check"></i> Aktif <b>{{ $activeProducts }}</b>
                        </div>
                        <div class="pillMini"><i class="fa-solid fa-bolt"></i> Flash <b>{{ $flashCount }}</b></div>
                        <div class="pillMini"><i class="fa-solid fa-triangle-exclamation"></i> Stok menipis
                            <b>{{ $lowStock }}</b></div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="toolbar">
                    <div class="searchWrap">
                        ...
                        <input type="text" placeholder="Cari produk (nama/kategori/SKU)…"
                            oninput="LBP.filter(this.value)">
                    </div>
                                ...
                                <table id="productsTable">
                                    ...
                                    <tbody id="productsBody">
                                        @foreach ($productsList as $p)
                                            ...
                                            <tr data-name="{{ strtolower($name . ' ' . $category . ' ' . $sku) }}"
                                                data-status="{{ $statusKey }}" data-stockkey="{{ $stockKey }}"
                                                        ...
                                                        <div style="min-width:0">
                                                            ...
                                                            <div class="pSub">
                                                                <span><i class="fa-solid fa-barcode"></i>
                                                                    {{ $sku }}</span>
                                                                @if ($isFlash)
                                                                    <span class="badge flash"><i
                                                                            class="fa-solid fa-bolt"></i> Flash</span>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <td>
                                                    ...
                                                    <span style="color:rgba(100,116,139,.88); font-weight:600"> •
                                                        {{ $stock }}</span>
                                                </td>

                                                <td>
                                                    @if ($isActive)
                                                        <span class="badge active"><i class="fa-solid fa-circle"></i>
                                                            Aktif</span>
                                                    @else
                                                        <span class="badge inactive"><i class="fa-solid fa-circle"></i>
                                                            Nonaktif</span>
                                                    @endif
                                                </td>
                                                ...
                                                <td style="text-align:right">
                                                    <div class="actions">
                                                        <a class="btn2 btnSm primary"
                                                            href="{{ route('seller.products.edit', $p->id) }}">
